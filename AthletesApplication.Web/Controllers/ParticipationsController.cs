...
namespace AthletesApplication.Web.Controllers
{
    public class ParticipationsController : Controller
    {
        ...
        public ParticipationsController(IParticipationService participationService, ICompetitionService competitionService, IAthleteService athleteService, ITournamentService tournamentService)
        {
